...
class Score {
	...
	/**
	 * Returns the base URL for files generated by the score extensions.
	 *
	 * @return string If the global configuration variable <code>$wgScorePath</code> is not <code>false</code>,
	 * 	the value of <code>$wgScorePath</code> is returned.
	 * 	Otherwise, <code>"$wgUploadPath/lilypond"</code> is returned.
	 */
	...
	/**
	 * Returns the file backend used to store files generated by the Score extension.
	 *
	 * @return FileBackend If the global configuration variable <code>$wgScoreFileBackend</code> holds a file backend name,
	 * 	the backend with that name is returned.
	 * 	Otherwise, a default backend is returned.
	 */
