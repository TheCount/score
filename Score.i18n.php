...
$1',
	...
	'score-invalidoggoverride' => 'The file you specified with override_ogg is invalid. Please specify the file name only, omit <nowiki>[[…]]</nowiki> and the "{{ns:file}}:" prefix.',
...
$1',
	'score-oggoverridenotfound' => 'The file you specified with override_ogg does not exist.',
	'score-page' => 'Page $1',
...
$messages['qqq'] = array(
	...
	'score-invalidoggoverride' => 'Displayed if the file specified with the override_ogg="…" attribute is invalid.',
	...
	'score-oggoverridenotfound' => 'Displayed if the file specified with the override_ogg="…" attribute could not be found.',
...
$1',
	...
	'score-invalidoggoverride' => 'Die Datei, die für <code>override_ogg</code> angegeben wurde, ist ungültig. Bitte nur den Dateinamen angeben und dabei <nowiki>[[…]]</nowiki> sowie das Prefix „{{ns:file}}:“ weglassen.',
...
$1',
	'score-oggoverridenotfound' => 'Die Datei, die für <code>override_ogg</code> angegeben wurde, ist nicht vorhanden.',
	'score-page' => 'Seite $1',
...
$1',
	...
	'score-invalidoggoverride' => 'Le fichier que vous avez spécifié avec override_ogg n\'est pas valide. Veuillez spécifier uniquement le nom du fichier, omettez <nowiki>[[…]]</nowiki> et le préfixe "{{ns:file}}:".',
...
$1',
	'score-oggoverridenotfound' => 'Le fichier que vous avez spécifié avec override_ogg n’existe pas.',
	'score-page' => 'Page $1',
...
$1',
	...
	'score-invalidoggoverride' => 'O ficheiro que especificou con override_ogg non é válido. Especifique unicamente o nome do ficheiro, omita <nowiki>[[…]]</nowiki> e o prefixo "{{ns:file}}:".',
...
$1',
	'score-oggoverridenotfound' => 'O ficheiro que especificou con override_ogg non existe.',
	'score-page' => 'Páxina $1',
...
$1',
	...
	'score-invalidoggoverride' => 'Le file que tu specificava con override_ogg es invalide. Per favor specifica le nomine del file solmente, omittente <nowiki>[[…]]</nowiki> e le prefixo "{{ns:file}}:".',
...
$1',
	...
	'score-invalidoggoverride' => 'Податотеката што ја укажавте со override_ogg е неважечка. Укажете го само нејзиното име, изоставувајќи го <nowiki>[[…]]</nowiki> и префиксот „{{ns:file}}:“.',
...
$1',
	'score-oggoverridenotfound' => 'Податотеката што ја укажавте со override_ogg не постои.',
...
$1',
	...
	'score-invalidoggoverride' => 'Het bestand dat u hebt opgegeven met "override_ogg is ongeldig". Gebruik alleen de bestandsnaam, laat <nowiki>[[…]]</nowiki> weg en gebruik het voorvoegsel "{{ns:file}}:".',
